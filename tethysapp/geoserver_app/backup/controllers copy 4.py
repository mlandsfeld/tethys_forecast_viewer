...
def home(request):
    ...
    eo_layers = "chirps_global_1-month-07-2015_mm_anomaly,africa:g2008_af_1"
    ...
    forecast_sld_file = "https://chc-ewx2.chc.ucsb.edu/sld/yield_ET_long/yield_ET_long_201261.sld"
    forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_yield.png'
    
    forecast_options = [
      ("ET Yield Forecast (long rains)",  "L_fcast_MAPE_ET"),
      ...
      ("Production (long rains)", "prod_long"), 
      ("Production (mean 10 years)", "prod_long_mean_10yr"), 
      ("Production (mean all years)", "prod_long_mean_all"), 
      ("Yield (long rains)", "yield_long"), 
      ("Yield (mean 10 years)", "yield_long_mean_10yr"), 
      ("Yield (mean all years)", "yield_long_mean_all"), 
    ]
    ...
    if request.POST and 'update_maps' in request.POST:
        ...
        if 'emodis' in selected_layer:
        	eo_time.format(year=year, month=month, dekad=dekad)
    ...
    #try: forecast_map_layers
    #except NameError: forecast_map_layers = []

    #if not "forecast_map_layers" in globals():
    #    print("no forecast map defined")
    ...
    if request.POST and 'update_maps' in request.POST:
        ...
        season = request.POST['forecast_season']
        print('selected_season: ' + season)
        forecast_season_options.initial=season
        ...
        if selected_layer == "ET_forecast_long":
          ...
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/et_crop_yield.png'
        ...
        if selected_layer == "ET_MAPE_long":
          ...
          forecast_sld_file = f"{sld_url}ET_MAPE/ET_MP_{month}_{dekad}.sld"
        ...
        if selected_layer == "area_long_mean_all":
          ...
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_area.png'
        if selected_layer == "prod_long":
          forecast_sld_file = f"{sld_url}prod/prod_L{year}.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_prod.png'
        if selected_layer == "prod_long_mean_10yr":
          forecast_sld_file = f"{sld_url}prod/prod_long_mean_10yr.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_prod.png'
        if selected_layer == "prod_long_mean_all":
          forecast_sld_file = f"{sld_url}prod/prod_long_mean_all.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_prod.png'
        if selected_layer == "yield_long":
          forecast_sld_file = f"{sld_url}yield/yield_L{year}.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_yield1.png'
        if selected_layer == "yield_long_mean_10yr":
          forecast_sld_file = f"{sld_url}yield/yield_long_mean_10yr.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_yield1.png'
        if selected_layer == "yield_long_mean_all":
          forecast_sld_file = f"{sld_url}yield/yield_long_mean_all.sld"
          forecast_legend_url='https://chc-ewx2.chc.ucsb.edu/images/legends/crop_yield1.png'
