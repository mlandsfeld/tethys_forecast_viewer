...
def home(request):
    ...
    forecast_options = [
      ("Yield Obs (long rains)",  "geoserver_app:yield_obs_ts_4"),
      ("Yield Obs (short rains)", "chirps_global_1-month-{month}-{year}_mm_data,africa:g2008_af_1"), 
      ("Yield Forecast (", "chirps_global_1-month-{month}-{year}_mm_anomaly,africa:g2008_af_1"), 
      ...
      ("CHIRTmax", "chirtmax_global_1-month-12-2016_C_data,africa:g2008_af_1"),
    ]
    ...
    if request.POST and 'eo_layer' in request.POST:
        ...
        layer = selected_layer.format(month=month, year=year)
    ...
    if request.POST and 'forecast_layer' in request.POST:
        print('In forecast_layer Post request')
    ...
    context = {'eo_map_options': eo_map_options,
               ...
               'forecast_layer': 'geoserver_app:yield_obs_ts_4',
    }
